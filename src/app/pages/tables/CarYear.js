    ...
    return (
        <div>
                   ...
                   <div className={classes.search} className="mb-2 displayFlex">
                        <TextField id="search-basic"type="year" label="search" value={search} onChange={(event) => setSearch(event.target.value)} />

                        <Button type="submit" variant="outlined" onClick={filterByYear} color="primary" className={classes.button} className="marginAuto">
                            Search 
                        </Button>
                    </div>
                   </div>
